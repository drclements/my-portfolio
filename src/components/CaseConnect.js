    ...
    <div className="mb-4">
      ...
      <Overview className="mt-5 mx-auto p-2 py-4" 
        ...
        <div className="p-4">
          ...
          <p className="mt-2">
            Case Connect is an custom case management solution geared towards helping a community based organization simplify thier workflow and documentation. I built this for my capstone project at Flatiron School where we were given 2 weeks to stand up a working product. Given my background in mental health and directing programs the last for years, this was a big motivator for me coming into the program as I seek to help other helping professionals with their administrative needs so that they can worry less about the nitty gritty and focus on their mission. This was a solo project and build from the ground up! The backend is handled by Ruby on Rails while the frontend was built with React. The relational data base was built with PostgreSQL using the well known MVC framework to ensure scalability and performance. I have integrated ActiveStorage to handle file management where caseworkers can upload images and pdfs relavent to their cases. Authorization is handled on the backend using BCrypt to hash your password. The app authenticates the user and based on their roles in the organization determines user access and permissions via protected routes. I integrated Chart.js to visualize data in real time; this was particularly useful for tracking treatment outcomes. I also incorporated FullCalendar for tracking program events. Finally, all of this was styled using styled components. My goal (which I feel I achieved) was to bring the cases to life so the user feels more connected to the clients they're working. I did not want yet another cold electronic health record!
          </p>
          <div className="center">
            {/* <a
